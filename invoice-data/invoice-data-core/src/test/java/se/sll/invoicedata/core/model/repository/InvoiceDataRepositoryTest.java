...
public class InvoiceDataRepositoryTest extends TestSupport {
    ...
    public void testInsertFind_InvocieDataEntity() {
        ...
        final List<InvoiceDataEntity> l = getInvoiceDataRepository().findBySupplierIdAndPaymentResponsibleAndCreatedTimeBetween(e.getSupplierId(), e.getPaymentResponsible(), CoreUtil.MIN_DATE, new Date());
    ...
    public void testInsertUpdateFind_assign_business_event() {
        ...
        List<InvoiceDataEntity> l = getInvoiceDataRepository().findBySupplierIdAndPaymentResponsibleAndCreatedTimeBetween(be.getSupplierId(), be.getPaymentResponsible(), CoreUtil.MIN_DATE, new Date());
