...
/****** Object:  Database [invoice-data]    Script Date: 10/17/2013 10:10:02 ******/
...
/****** Object:  Database [invoice-data]    Script Date: 10/17/2013 10:10:02 ******/
CREATE DATABASE [invoice-data]
GO

ALTER DATABASE [invoice-data] MODIFY FILE
( NAME = N'invoice-data',SIZE = 524288KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
